          ...
          <div className="row g-3">
            ...
            <FeatureFlow
              ...
              steps={[
                ...
                "Dieci lenti data-anchored (commercio, turismo, lavoro, trasporti, welfare, istruzione, casa, reddito, ambiente, sanità) + OpenCoesione e ISPRA raccolgono l'evidenza.",
