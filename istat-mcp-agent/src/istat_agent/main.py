"""Interactive CLI for the ISTAT agent."""
...
def cli() -> None:
    parser = argparse.ArgumentParser(
        prog="istat-agent",
        description="Microsoft Agent Framework CLI on top of the ISTAT MCP server",
    )
    parser.add_argument(
        "query",
        nargs="?",
