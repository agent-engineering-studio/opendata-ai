    ...
    *,
    ...
    async def aggregate(
        ...
        if req.modalita == "completa":
            ...
            # Il marketing gira sempre quando l'agente è disponibile (enable_web): la
            # regola è DEGRADABILE — gli spunti sopravvivono sulla sola premessa locale
            # (fattibilità ridotta) anche senza ispirazione esterna, su qualsiasi provider.
            run_marketing = marketing_agent is not None
