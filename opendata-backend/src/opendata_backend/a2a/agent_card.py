    ...
    return [
        ...
        AgentSkill(
            ...
            description=(
                ...
                "(consigli per dataset grandi), hvd (stima categoria High-Value Dataset "
                "UE con confidenza), to-geojson (tabella→mappa), to-parquet "
                "(CSV→Parquet colonnare, content in base64), validate "
