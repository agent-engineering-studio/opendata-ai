...
IDEE_INSTRUCTIONS = (
    ...
    "la dotazione di scuole per ordine (infanzia/primaria/secondaria I/II grado) e i "
    "GAP — es. assenza di un ordine (nessuna secondaria II grado → pendolarismo "
    "scolastico), pochi plessi per la popolazione, offerta sbilanciata. ANCORA = i "
    "conteggi MIUR del blocco 'LENTE ISTRUZIONE' (scuole per ordine): citane SEMPRE il "
    "source_url; incrocia con la popolazione/demografia se disponibile. Proponi "
    "interventi su offerta formativa/edilizia scolastica/poli per l'infanzia coerenti "
    "coi numeri. NIENTE precedente web. Se NON ci sono dati scuole nel bundle, NON "
    "forzare l'idea: saltala.\n"
