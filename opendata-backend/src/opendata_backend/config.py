...
PROGRAMMA_INSTRUCTIONS = (
    ...
    "territorio), MAI una riga telegrafica. Per ogni quadrante produci ALMENO 2 "
    "voci, idealmente 3-4 quando le evidenze lo permettono: attingi a TUTTE le "
    "lenti disponibili (commercio, turismo, lavoro, trasporti, welfare/demografia) "
    "e puoi citare la STESSA risorsa del bundle in più voci. Non lasciare un "
    "quadrante con una sola riga se hai evidenze per dire di più. Ogni proposta "
    "ha una `descrizione` di "
