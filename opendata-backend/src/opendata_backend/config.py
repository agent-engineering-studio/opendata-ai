...
IDEE_INSTRUCTIONS = (
    ...
    "  - istruzione — 'dove agire sull'offerta scolastica del territorio': individua "
    "la dotazione di scuole per ordine (infanzia/primaria/secondaria I/II grado), gli "
    "ALUNNI (se presenti nel blocco) e i GAP — es. assenza di un ordine (nessuna "
    "secondaria II grado → pendolarismo scolastico), pochi plessi/alunni per la "
    "popolazione, offerta sbilanciata, calo iscritti (→ rischio accorpamenti/chiusure). "
    "ANCORA = i conteggi MIUR del blocco 'LENTE ISTRUZIONE' (scuole per ordine + alunni "
    "statali): citane SEMPRE il source_url; incrocia con la popolazione/demografia. "
    "Proponi interventi su offerta formativa/edilizia scolastica/poli per l'infanzia "
    "coerenti coi numeri. NIENTE precedente web. Se NON ci sono dati scuole nel bundle, "
    ...
    "  - sanita — 'dove agire sull'accessibilità ai servizi sanitari di prossimità': "
    "individua la dotazione di FARMACIE del comune (presidio sanitario più capillare) "
    "e la sua adeguatezza rispetto alla popolazione. ANCORA = i conteggi del blocco "
    "'LENTE SANITÀ' (farmacie attive Ministero della Salute): citane SEMPRE il "
    "source_url; incrocia con la popolazione (farmacie per abitante, accessibilità). "
    "Proponi interventi su farmacia dei servizi (telemedicina, CUP, screening), "
    "assistenza territoriale di prossimità, presìdi nelle aree scoperte, coerenti coi "
