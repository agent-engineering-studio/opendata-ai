...
IDEE_INSTRUCTIONS = (
    ...
    "(Distretto Urbano del Commercio)': incrocia la base imprenditoriale (ISTAT "
    "ASIA imprese attive, ATECO sez. G) + la DENSITÀ commerciale per zona (OSM, "
    "tool osm_commercial_profile) + la demografia, per individuare DOVE il "
    "commercio è sottodimensionato. Le evidenze DEVONO includere un indicatore "
    "ISTAT imprese OPPURE il source_url della densità commerciale OSM; e l'idea "
    "DEVE NOMINARE la zona/quartiere preso dal blocco ZONE CANDIDATE della "
    "RICHIESTA (es. 'nel quartiere X / zona commerciale Y'), coi conteggi di "
    "densità nel `dettaglio`. Niente precedente web richiesto: è ancorata ai "
    "dati locali.\n\n"
